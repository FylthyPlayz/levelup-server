    ...
    def get(self, request):
        with connection.cursor() as db_cursor:
            ...
            for row in dataset:
                ...
                game = {'id': row['id'], 'title': row['title'], 
                'number_of_players': row['number_of_players'], 'maker': row['maker'], 
                'game_type_id': row['game_type_id'], 'skill_level': row['skill_level']
                }
                ...
                user_dict = next(
                    (
                        ...
                        if user_game['gamer_id'] == row['user_id']
                    ),
                    None
                )
